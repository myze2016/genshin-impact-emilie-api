...
class CharacterArtifactController extends Controller
{
    ...
    public function store(Request $request) {
        $characterWeapon = CharacterArtifact::create($request->all());
        return response()->json([
    ...
    public function deleteArtifactByCharacter(Request $request) {
        $characterArtifact = CharacterArtifact::where('character_id', $request->character_id)
            ->where('artifact_id', $request->artifact_id)
            ->delete();
        return response()->json([
            'character_artifact' => $characterArtifact,
            'success' => true,
